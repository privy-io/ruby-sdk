...
module Privy
  module Models
    class WalletActionEarnDepositFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::WalletActionEarnDepositFailedWebhookPayload::Status::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          Privy::WalletActionEarnDepositFailedWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          raw_amount: String,
          status:
            Privy::WalletActionEarnDepositFailedWebhookPayload::Status::OrSymbol,
          steps:
            T::Array[
              T.any(
          ...
          type:
            Privy::WalletActionEarnDepositFailedWebhookPayload::Type::OrSymbol,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionEarnDepositFailedWebhookPayload::Status
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionEarnDepositFailedWebhookPayload::Type
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WALLET_ACTION_EARN_DEPOSIT_FAILED =
          T.let(
