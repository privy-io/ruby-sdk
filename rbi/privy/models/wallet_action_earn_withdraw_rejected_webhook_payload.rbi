...
module Privy
  module Models
    class WalletActionEarnWithdrawRejectedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::WalletActionEarnWithdrawRejectedWebhookPayload::Status::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          Privy::WalletActionEarnWithdrawRejectedWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          raw_amount: String,
          status:
            Privy::WalletActionEarnWithdrawRejectedWebhookPayload::Status::OrSymbol,
          steps:
            T::Array[
              T.any(
          ...
          type:
            Privy::WalletActionEarnWithdrawRejectedWebhookPayload::Type::OrSymbol,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionEarnWithdrawRejectedWebhookPayload::Status
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionEarnWithdrawRejectedWebhookPayload::Type
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WALLET_ACTION_EARN_WITHDRAW_REJECTED =
          T.let(
