...
module Privy
  module Models
    class WalletActionPayoutRejectedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::WalletActionPayoutRejectedWebhookPayload::Status::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          Privy::WalletActionPayoutRejectedWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          source_chain: String,
          status:
            Privy::WalletActionPayoutRejectedWebhookPayload::Status::OrSymbol,
          steps:
            T::Array[
              T.any(
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionPayoutRejectedWebhookPayload::Status
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::WalletActionPayoutRejectedWebhookPayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WALLET_ACTION_PAYOUT_REJECTED =
          T.let(
