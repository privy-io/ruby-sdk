...
module Privy
  module Models
    class WalletActionTransferFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::WalletActionTransferFailedWebhookPayload::Status::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          Privy::WalletActionTransferFailedWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          source_chain: String,
          status:
            Privy::WalletActionTransferFailedWebhookPayload::Status::OrSymbol,
          steps:
            T::Array[
              T.any(
          ...
          type: Privy::WalletActionTransferFailedWebhookPayload::Type::OrSymbol,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionTransferFailedWebhookPayload::Status
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::WalletActionTransferFailedWebhookPayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WALLET_ACTION_TRANSFER_FAILED =
          T.let(
