  ...
  module Models
    module Wallets
      class AaveVaultDetails < Privy::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Privy::Wallets::AaveVaultDetails, Privy::Internal::AnyHash)
          end
        ...
        module Provider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Privy::Wallets::AaveVaultDetails::Provider)
            end
          ...
          sig do
            override.returns(
              T::Array[Privy::Wallets::AaveVaultDetails::Provider::TaggedSymbol]
            )
          end
          def self.values
          end
