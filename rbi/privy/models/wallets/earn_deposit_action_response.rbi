  ...
  module Models
    module Wallets
      class EarnDepositActionResponse < Privy::Internal::Type::BaseModel
        ...
        sig do
          returns(Privy::Wallets::EarnDepositActionResponse::Type::TaggedSymbol)
        end
        attr_accessor :type
        ...
        sig do
          params(
            ...
            type: Privy::Wallets::EarnDepositActionResponse::Type::OrSymbol,
          ...
          override.returns(
            {
              ...
              type:
                Privy::Wallets::EarnDepositActionResponse::Type::TaggedSymbol,
              vault_address: String,
              vault_id: String,
              wallet_id: String,
              amount: String,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Privy::Wallets::EarnDepositActionResponse::Type)
            end
