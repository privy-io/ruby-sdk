  ...
  module Models
    module Wallets
      class TransferActionResponse < Privy::Internal::Type::BaseModel
        ...
        sig do
          returns(Privy::Wallets::TransferActionResponse::Type::TaggedSymbol)
        end
        attr_accessor :type
        ...
        sig do
          params(
            ...
            type: Privy::Wallets::TransferActionResponse::Type::OrSymbol,
            wallet_id: String,
          ...
          override.returns(
            {
              ...
              type: Privy::Wallets::TransferActionResponse::Type::TaggedSymbol,
              wallet_id: String,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Privy::Wallets::TransferActionResponse::Type)
            end
          ...
          TRANSFER =
            T.let(
              :transfer,
              Privy::Wallets::TransferActionResponse::Type::TaggedSymbol
            )
