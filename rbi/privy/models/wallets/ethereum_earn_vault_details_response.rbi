    ...
    module Wallets
      class EthereumEarnVaultDetailsResponse < Privy::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Privy::Wallets::EthereumEarnVaultDetailsResponse,
        ...
        sig { returns(Privy::Wallets::EthereumEarnProvider::OrSymbol) }
        ...
        sig do
          params(
            ...
            caip2: String,
            name: String,
            provider: Privy::Wallets::EthereumEarnProvider::OrSymbol,
