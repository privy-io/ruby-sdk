...
module Privy
  module Models
    class ExternalFiatAccount < Privy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Privy::ExternalFiatAccount, Privy::Internal::AnyHash)
        end
      ...
      sig { returns(Privy::ExternalFiatAccount::Provider::TaggedSymbol) }
      ...
      sig do
        params(
          ...
          provider: Privy::ExternalFiatAccount::Provider::OrSymbol,
          user_id: String,
          bank_name: String,
          last_4: String
        ...
        override.returns(
          {
            ...
            provider: Privy::ExternalFiatAccount::Provider::TaggedSymbol,
            user_id: String,
            bank_name: String,
            last_4: String
          }
      ...
      module Provider
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Privy::ExternalFiatAccount::Provider) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        BRIDGE =
          T.let(:bridge, Privy::ExternalFiatAccount::Provider::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Privy::ExternalFiatAccount::Provider::TaggedSymbol]
          )
        end
        def self.values
        end
