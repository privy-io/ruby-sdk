...
module Privy
  module Models
    class TransactionProviderErrorWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::TransactionProviderErrorWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::TransactionProviderErrorWebhookPayload::Type::OrSymbol,
          wallet_id: String,
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::TransactionProviderErrorWebhookPayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        TRANSACTION_PROVIDER_ERROR =
          T.let(
