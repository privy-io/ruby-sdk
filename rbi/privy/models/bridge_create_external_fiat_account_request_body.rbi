  ...
  module Models
    class BridgeCreateExternalFiatAccountRequestBody < Privy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Privy::BridgeCreateExternalFiatAccountRequestBody,
      ...
      sig do
        returns(
          Privy::BridgeCreateExternalFiatAccountRequestBody::Provider::OrSymbol
        )
      end
      ...
      module Provider
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::BridgeCreateExternalFiatAccountRequestBody::Provider
            )
          end
        ...
        BRIDGE =
          T.let(
            :bridge,
            Privy::BridgeCreateExternalFiatAccountRequestBody::Provider::TaggedSymbol
          )
