...
module Privy
  module Models
    class UserUnlinkedAccountWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(Privy::UserUnlinkedAccountWebhookPayload::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::UserUnlinkedAccountWebhookPayload::Type::OrSymbol,
        ...
        override.returns(
          {
            ...
            type: Privy::UserUnlinkedAccountWebhookPayload::Type::TaggedSymbol,
            user: Privy::User
          }
        )
      end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::UserUnlinkedAccountWebhookPayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        USER_UNLINKED_ACCOUNT =
          T.let(
            :"user.unlinked_account",
            Privy::UserUnlinkedAccountWebhookPayload::Type::TaggedSymbol
          )
