...
module Privy
  module Models
    class TransactionStillPendingWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      # 0, 1, 2, and 4.
      sig { returns(Privy::UnsignedStandardEthereumTransaction) }
      ...
      sig do
        returns(
          Privy::TransactionStillPendingWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          transaction_request:
            Privy::UnsignedStandardEthereumTransaction::OrHash,
          type: Privy::TransactionStillPendingWebhookPayload::Type::OrSymbol,
          wallet_id: String,
        ...
        override.returns(
          {
            ...
            transaction_hash: String,
            transaction_id: String,
            transaction_request: Privy::UnsignedStandardEthereumTransaction,
            type:
              Privy::TransactionStillPendingWebhookPayload::Type::TaggedSymbol,
            wallet_id: String,
            reference_id: T.nilable(String)
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::TransactionStillPendingWebhookPayload::Type)
          end
