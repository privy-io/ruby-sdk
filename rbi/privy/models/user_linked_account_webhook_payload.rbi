...
module Privy
  module Models
    class UserLinkedAccountWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(Privy::UserLinkedAccountWebhookPayload::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::UserLinkedAccountWebhookPayload::Type::OrSymbol,
        ...
        override.returns(
          {
            ...
            type: Privy::UserLinkedAccountWebhookPayload::Type::TaggedSymbol,
            user: Privy::User
          }
        )
      end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::UserLinkedAccountWebhookPayload::Type)
          end
        ...
        USER_LINKED_ACCOUNT =
          T.let(
            :"user.linked_account",
            Privy::UserLinkedAccountWebhookPayload::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Privy::UserLinkedAccountWebhookPayload::Type::TaggedSymbol]
          )
        end
        def self.values
        end
