...
module Privy
  module Models
    class UserUpdatedAccountWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(Privy::UserUpdatedAccountWebhookPayload::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::UserUpdatedAccountWebhookPayload::Type::OrSymbol,
        ...
        override.returns(
          {
            ...
            type: Privy::UserUpdatedAccountWebhookPayload::Type::TaggedSymbol,
            user: Privy::User
          }
        )
      end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::UserUpdatedAccountWebhookPayload::Type)
          end
        ...
        USER_UPDATED_ACCOUNT =
          T.let(
            ...
            Privy::UserUpdatedAccountWebhookPayload::Type::TaggedSymbol
          )
