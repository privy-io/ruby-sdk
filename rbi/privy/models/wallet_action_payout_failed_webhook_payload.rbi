...
module Privy
  module Models
    class WalletActionPayoutFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::WalletActionPayoutFailedWebhookPayload::Status::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          Privy::WalletActionPayoutFailedWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          source_chain: String,
          status:
            Privy::WalletActionPayoutFailedWebhookPayload::Status::OrSymbol,
          steps:
            T::Array[
              T.any(
          ...
          type: Privy::WalletActionPayoutFailedWebhookPayload::Type::OrSymbol,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::WalletActionPayoutFailedWebhookPayload::Status)
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::WalletActionPayoutFailedWebhookPayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WALLET_ACTION_PAYOUT_FAILED =
          T.let(
