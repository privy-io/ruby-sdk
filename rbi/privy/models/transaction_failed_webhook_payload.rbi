...
module Privy
  module Models
    class TransactionFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(Privy::TransactionFailedWebhookPayload::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::TransactionFailedWebhookPayload::Type::OrSymbol,
          wallet_id: String,
        ...
        override.returns(
          {
            ...
            transaction_hash: String,
            transaction_id: String,
            type: Privy::TransactionFailedWebhookPayload::Type::TaggedSymbol,
            wallet_id: String,
            reference_id: T.nilable(String)
          }
        )
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::TransactionFailedWebhookPayload::Type)
          end
        ...
        TRANSACTION_FAILED =
          T.let(
            :"transaction.failed",
            Privy::TransactionFailedWebhookPayload::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Privy::TransactionFailedWebhookPayload::Type::TaggedSymbol]
          )
        end
        def self.values
        end
