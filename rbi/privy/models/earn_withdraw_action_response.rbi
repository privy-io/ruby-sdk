...
module Privy
  module Models
    class EarnWithdrawActionResponse < Privy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Privy::EarnWithdrawActionResponse, Privy::Internal::AnyHash)
        end
      ...
      sig { returns(Privy::EarnWithdrawActionResponse::Type::TaggedSymbol) }
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::EarnWithdrawActionResponse::Type::OrSymbol,
        ...
        override.returns(
          {
            ...
            type: Privy::EarnWithdrawActionResponse::Type::TaggedSymbol,
            vault_address: String,
            vault_id: String,
            wallet_id: String,
            amount: String,
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::EarnWithdrawActionResponse::Type)
          end
        ...
        EARN_WITHDRAW =
          T.let(
            :earn_withdraw,
            Privy::EarnWithdrawActionResponse::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Privy::EarnWithdrawActionResponse::Type::TaggedSymbol]
          )
        end
        def self.values
        end
