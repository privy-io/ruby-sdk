...
module Privy
  module Models
    class TransactionConfirmedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(Privy::TransactionConfirmedWebhookPayload::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::TransactionConfirmedWebhookPayload::Type::OrSymbol,
          wallet_id: String,
        ...
        override.returns(
          {
            ...
            transaction_hash: String,
            transaction_id: String,
            type: Privy::TransactionConfirmedWebhookPayload::Type::TaggedSymbol,
            wallet_id: String,
            reference_id: T.nilable(String)
          }
        )
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::TransactionConfirmedWebhookPayload::Type)
          end
        ...
        TRANSACTION_CONFIRMED =
          T.let(
            ...
            Privy::TransactionConfirmedWebhookPayload::Type::TaggedSymbol
          )
