...
module Privy
  module Models
    class TransactionExecutionRevertedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Privy::TransactionExecutionRevertedWebhookPayload::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type:
            Privy::TransactionExecutionRevertedWebhookPayload::Type::OrSymbol,
          wallet_id: String,
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::TransactionExecutionRevertedWebhookPayload::Type
            )
          end
