...
module Privy
  module Models
    class TransactionReplacedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        returns(Privy::TransactionReplacedWebhookPayload::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Privy::TransactionReplacedWebhookPayload::Type::OrSymbol,
          wallet_id: String,
        ...
        override.returns(
          {
            ...
            transaction_hash: String,
            transaction_id: String,
            type: Privy::TransactionReplacedWebhookPayload::Type::TaggedSymbol,
            wallet_id: String,
            reference_id: T.nilable(String)
          }
        )
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::TransactionReplacedWebhookPayload::Type)
          end
        ...
        TRANSACTION_REPLACED =
          T.let(
            ...
            Privy::TransactionReplacedWebhookPayload::Type::TaggedSymbol
          )
