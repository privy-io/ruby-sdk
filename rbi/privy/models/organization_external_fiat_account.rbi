  ...
  module Models
    class OrganizationExternalFiatAccount < Privy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Privy::OrganizationExternalFiatAccount,
      ...
      sig do
        returns(Privy::OrganizationExternalFiatAccount::Provider::TaggedSymbol)
      end
      ...
      sig do
        params(
          ...
          provider: Privy::OrganizationExternalFiatAccount::Provider::OrSymbol,
          bank_name: String,
          last_4: String
        ...
        override.returns(
          {
            ...
            organization_id: String,
            provider:
              Privy::OrganizationExternalFiatAccount::Provider::TaggedSymbol,
            bank_name: String,
            last_4: String
          }
        )
      ...
      module Provider
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::OrganizationExternalFiatAccount::Provider)
          end
