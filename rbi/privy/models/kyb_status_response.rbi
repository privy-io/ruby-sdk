...
module Privy
  module Models
    class KYBStatusResponse < Privy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Privy::KYBStatusResponse, Privy::Internal::AnyHash)
        end
      ...
      sig { params(kyb: Privy::KyxVerificationStatusDetail::OrHash).void }
      attr_writer :kyb
      ...
      sig do
        params(
          ...
          kyb: Privy::KyxVerificationStatusDetail::OrHash,
