    ...
    class WalletActionSwapSucceededWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      sig do
        params(
          ...
          output_token: String,
          status:
            Privy::WalletActionSwapSucceededWebhookPayload::Status::OrSymbol,
          steps:
            T::Array[
              T.any(
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Privy::WalletActionSwapSucceededWebhookPayload::Status
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Privy::WalletActionSwapSucceededWebhookPayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WALLET_ACTION_SWAP_SUCCEEDED =
          T.let(
