...
module Privy
  module Models
    class EthereumYieldPositionResponse < Privy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Privy::EthereumYieldPositionResponse, Privy::Internal::AnyHash)
        end

      sig { returns(Privy::EthereumYieldPositionResponse::Asset) }
      attr_reader :asset

      sig do
        params(asset: Privy::EthereumYieldPositionResponse::Asset::OrHash).void
      end
      attr_writer :asset
      ...
      sig do
        params(
          asset: Privy::EthereumYieldPositionResponse::Asset::OrHash,
      ...
      sig do
        override.returns(
          {
            asset: Privy::EthereumYieldPositionResponse::Asset,
            assets_in_vault: String,
            shares_in_vault: String,
            total_deposited: String,
            total_withdrawn: String
      ...
      class Asset < Privy::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Privy::EthereumYieldPositionResponse::Asset,
