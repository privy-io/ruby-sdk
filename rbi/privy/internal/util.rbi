    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data:
              T.any(Privy::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick:
              T.nilable(
                T.any(
                  Symbol,
      ...
      class << self
        ...
        # @api private
        sig do
          params(parsed: Privy::Internal::Util::ParsedUri).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: Privy::Internal::Util::ParsedUri,
            rhs: Privy::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: Privy::Internal::AnyHash).returns(
        ...
        sig do
          params(
            collection: Privy::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Privy::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Privy::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
