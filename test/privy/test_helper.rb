...
class Privy::Test::SingletonClient < Privy::Client
  include Singleton
  ...
  def initialize
    super(
      base_url: Privy::Test::SingletonClient::TEST_API_BASE_URL,
      app_id: "My App ID",
...
class Privy::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @privy_api = Privy::Test::SingletonClient.instance
  end
