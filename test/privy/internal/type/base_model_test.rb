...
class Privy::Test::PrimitiveModelTest < Minitest::Test
  A = Privy::Internal::Type::ArrayOf[-> { Integer }]
  H = Privy::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Privy::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Privy::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Privy::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Privy::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Privy::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Privy::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Privy::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Privy::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Privy::Internal::Type::Boolean, true] => true,
      [Privy::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Privy::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Privy::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Privy::Internal::Type::Converter.new_coerce_state
      Privy::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Privy::Internal::Type::Converter.dump(target, input, state: state)
...
class Privy::Test::EnumModelTest < Minitest::Test
  class E0
    include Privy::Internal::Type::Enum
...
class Privy::Test::CollectionModelTest < Minitest::Test
  A1 = Privy::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Privy::Internal::Type::HashOf[Integer]

  A2 = Privy::Internal::Type::ArrayOf[H1]
  H2 = Privy::Internal::Type::HashOf[-> { A1 }]

  A3 = Privy::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Privy::Internal::Type::HashOf[Integer, nil?: true]
...
class Privy::Test::BaseModelTest < Minitest::Test
  class M1 < Privy::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Privy::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Privy::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Privy::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Privy::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Privy::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Privy::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Privy::Errors::ConversionError => e
...
class Privy::Test::UnionTest < Minitest::Test
  class U0
    include Privy::Internal::Type::Union
  ...
  class M2 < Privy::Internal::Type::BaseModel
  ...
  class M4 < Privy::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Privy::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Privy::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Privy::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Privy::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Privy::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Privy::Internal::Type::Unknown, Privy::Internal::Type::Unknown] => true,
      [Privy::Internal::Type::Boolean, Privy::Internal::Type::Boolean] => true,
      [Privy::Internal::Type::Unknown, Privy::Internal::Type::Boolean] => false,
...
class Privy::Test::MetaInfoTest < Minitest::Test
  A1 = Privy::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Privy::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
