...
class PrivyTest < Minitest::Test
  ...
  def test_raises_on_unknown_environment
    e = assert_raises(ArgumentError) do
      Privy::Client.new(environment: "wrong")
    end
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:get, "http://localhost/v1/wallets/wallet_id").to_return_json(status: 500, body: {})

    privy_api =
      Privy::Client.new(base_url: "http://localhost", app_id: "My App ID", app_secret: "My App Secret")

    assert_raises(Privy::Errors::InternalServerError) do
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Privy::Errors::InternalServerError) do
      privy_api.wallets.get("wallet_id", request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Privy::Errors::InternalServerError) do
      privy_api.wallets.get("wallet_id", request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    stub_request(:get, "http://localhost/v1/wallets/wallet_id").to_return_json(
      status: 500,
  ...
  def test_omit_retry_count_header
    ...
    assert_raises(Privy::Errors::InternalServerError) do
      privy_api.wallets.get("wallet_id", request_options: {extra_headers: {"x-stainless-retry-count" => nil}})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(Privy::Errors::APIConnectionError) do
      privy_api.wallets.get("wallet_id", request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: Privy::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Privy::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_raises(Privy::Errors::APIConnectionError) do
      privy_api.wallets.get("wallet_id", request_options: {extra_headers: {"authorization" => "Bearer xyz"}})
    end
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Privy::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:get, "http://localhost/v1/wallets/wallet_id").to_return_json(status: 200, body: {})
