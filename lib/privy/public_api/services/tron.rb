...
module Privy
  module Services
    class Tron
      ...
      # @param params [Hash] The raw_data for tron_signTransaction. Required fields:
      #   contract, ref_block_bytes, ref_block_hash, expiration, timestamp.
      ...
      def sign_transaction(
        ...
        response = @wallets.rpc(
          wallet_id,
          wallet_rpc_request_body: {method: :tron_signTransaction, params: {raw_data: params}},
      ...
      #
      # @param wallet_id [String] ID of the wallet.
      # @param params [Hash] The raw_data for tron_sendTransaction.
      ...
      def send_transaction(
        ...
        body = {method: :tron_sendTransaction, params: {raw_data: params}}
