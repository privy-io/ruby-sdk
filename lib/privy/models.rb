...
module Privy
  ...
  AutomationAssetFilterInputExclude = Privy::Models::AutomationAssetFilterInputExclude

  AutomationAssetFilterInputInclude = Privy::Models::AutomationAssetFilterInputInclude
  ...
  AutomationDepositTriggerConfigInput = Privy::Models::AutomationDepositTriggerConfigInput
  ...
  BridgeCreateExternalFiatAccountRequestBody = Privy::Models::BridgeCreateExternalFiatAccountRequestBody

  BridgeCreateFiatDepositAccountRequestBody = Privy::Models::BridgeCreateFiatDepositAccountRequestBody
  ...
  BridgeOrganizationExternalFiatAccount = Privy::Models::BridgeOrganizationExternalFiatAccount
  ...
  BridgeUsdFiatVirtualAccountDepositPaymentRail =
    Privy::Models::BridgeUsdFiatVirtualAccountDepositPaymentRail
  ...
  CardIssuingCustomerNotCreatedResponse = Privy::Models::CardIssuingCustomerNotCreatedResponse
  ...
  CreateCryptoDepositAccountRequestBody = Privy::Models::CreateCryptoDepositAccountRequestBody

  CreateCryptoDepositAccountResponse = Privy::Models::CreateCryptoDepositAccountResponse
  ...
  CreateExternalFiatAccountRequestBody = Privy::Models::CreateExternalFiatAccountRequestBody

  CreateFiatDepositAccountRequestBody = Privy::Models::CreateFiatDepositAccountRequestBody
  ...
  EthereumTransactionConditionField = Privy::Models::EthereumTransactionConditionField

  EthereumTypedDataDomainCondition = Privy::Models::EthereumTypedDataDomainCondition

  EthereumTypedDataDomainConditionField = Privy::Models::EthereumTypedDataDomainConditionField
  ...
  ExternalFiatAccountSwiftCategory = Privy::Models::ExternalFiatAccountSwiftCategory

  ExternalFiatAccountSwiftData = Privy::Models::ExternalFiatAccountSwiftData

  ExternalFiatAccountSwiftPurposeOfFunds = Privy::Models::ExternalFiatAccountSwiftPurposeOfFunds
  ...
  GetStripeOnrampTransactionLimitsQueryParams = Privy::Models::GetStripeOnrampTransactionLimitsQueryParams

  GetStripeOnrampTransactionLimitsResponse = Privy::Models::GetStripeOnrampTransactionLimitsResponse
  ...
  KrakenEmbedAssetSortOption = Privy::Models::KrakenEmbedAssetSortOption

  KrakenEmbedCancelCustomOrderInput = Privy::Models::KrakenEmbedCancelCustomOrderInput

  KrakenEmbedCancelCustomOrderPath = Privy::Models::KrakenEmbedCancelCustomOrderPath

  KrakenEmbedCancelCustomOrderResponse = Privy::Models::KrakenEmbedCancelCustomOrderResponse

  KrakenEmbedCancelCustomOrderResult = Privy::Models::KrakenEmbedCancelCustomOrderResult

  KrakenEmbedCountryCode = Privy::Models::KrakenEmbedCountryCode

  KrakenEmbedCreateCustomOrderInput = Privy::Models::KrakenEmbedCreateCustomOrderInput

  KrakenEmbedCreateCustomOrderResponse = Privy::Models::KrakenEmbedCreateCustomOrderResponse

  KrakenEmbedCreateCustomOrderResult = Privy::Models::KrakenEmbedCreateCustomOrderResult
  ...
  KrakenEmbedCustomOrderOccurrenceStatus = Privy::Models::KrakenEmbedCustomOrderOccurrenceStatus

  KrakenEmbedCustomOrderOccurrenceTrigger = Privy::Models::KrakenEmbedCustomOrderOccurrenceTrigger

  KrakenEmbedCustomOrderOccurrenceTriggerType = Privy::Models::KrakenEmbedCustomOrderOccurrenceTriggerType

  KrakenEmbedCustomOrderQuoteAsset = Privy::Models::KrakenEmbedCustomOrderQuoteAsset

  KrakenEmbedCustomOrderStatus = Privy::Models::KrakenEmbedCustomOrderStatus

  KrakenEmbedCustomOrderStatusValue = Privy::Models::KrakenEmbedCustomOrderStatusValue

  KrakenEmbedCustomOrderTrigger = Privy::Models::KrakenEmbedCustomOrderTrigger

  KrakenEmbedCustomOrderTriggerCondition = Privy::Models::KrakenEmbedCustomOrderTriggerCondition
  ...
  KrakenEmbedGetCustomOrderHistoryResponse = Privy::Models::KrakenEmbedGetCustomOrderHistoryResponse

  KrakenEmbedGetCustomOrderHistoryResult = Privy::Models::KrakenEmbedGetCustomOrderHistoryResult

  KrakenEmbedGetCustomOrderQueryParams = Privy::Models::KrakenEmbedGetCustomOrderQueryParams
  ...
  KrakenEmbedIdentityDocumentType = Privy::Models::KrakenEmbedIdentityDocumentType

  KrakenEmbedIncludeCurrentDayPnlQueryParam = Privy::Models::KrakenEmbedIncludeCurrentDayPnlQueryParam

  KrakenEmbedListCustomOrdersQueryParams = Privy::Models::KrakenEmbedListCustomOrdersQueryParams

  KrakenEmbedListCustomOrdersResponse = Privy::Models::KrakenEmbedListCustomOrdersResponse
  ...
  KrakenEmbedQuoteType = Privy::Models::KrakenEmbedQuoteType

  KrakenEmbedResidence = Privy::Models::KrakenEmbedResidence

  KrakenEmbedResidenceDocumentType = Privy::Models::KrakenEmbedResidenceDocumentType

  KrakenEmbedSortingOrder = Privy::Models::KrakenEmbedSortingOrder

  KrakenEmbedStartAddressMetadata = Privy::Models::KrakenEmbedStartAddressMetadata

  KrakenEmbedStartAddressVerificationURLInput = Privy::Models::KrakenEmbedStartAddressVerificationURLInput

  KrakenEmbedStartIdentityInfo = Privy::Models::KrakenEmbedStartIdentityInfo

  KrakenEmbedStartIdentityMetadata = Privy::Models::KrakenEmbedStartIdentityMetadata
  ...
  KrakenEmbedStartVerificationDebug = Privy::Models::KrakenEmbedStartVerificationDebug

  KrakenEmbedStartVerificationURLInput = Privy::Models::KrakenEmbedStartVerificationURLInput
  ...
  KrakenEmbedTransactionStatus = Privy::Models::KrakenEmbedTransactionStatus

  KrakenEmbedTransactionType = Privy::Models::KrakenEmbedTransactionType
  ...
  LinkedAccountBaseWalletType = Privy::Models::LinkedAccountBaseWalletType
  ...
  LinkedAccountPasskeyCredentialDeviceType = Privy::Models::LinkedAccountPasskeyCredentialDeviceType
  ...
  OAuthTokenDeviceCodePendingErrorCode = Privy::Models::OAuthTokenDeviceCodePendingErrorCode
  ...
  OrganizationExternalFiatAccount = Privy::Models::OrganizationExternalFiatAccount

  OrganizationExternalFiatAccountResponse = Privy::Models::OrganizationExternalFiatAccountResponse
  ...
  OrganizationKYBUpdatedWebhookEvent = Privy::Models::OrganizationKYBUpdatedWebhookEvent
  ...
  SolanaSystemProgramInstructionConditionField =
    Privy::Models::SolanaSystemProgramInstructionConditionField

  SolanaTokenProgramInstructionCondition = Privy::Models::SolanaTokenProgramInstructionCondition

  SolanaTokenProgramInstructionConditionField = Privy::Models::SolanaTokenProgramInstructionConditionField
  ...
  TronSendTransactionRpcInputParams = Privy::Models::TronSendTransactionRpcInputParams

  TronSendTransactionRpcResponse = Privy::Models::TronSendTransactionRpcResponse

  TronSendTransactionRpcResponseData = Privy::Models::TronSendTransactionRpcResponseData

  TronSignTransactionRpcInput = Privy::Models::TronSignTransactionRpcInput

  TronSignTransactionRpcInputParams = Privy::Models::TronSignTransactionRpcInputParams

  TronSignTransactionRpcResponse = Privy::Models::TronSignTransactionRpcResponse

  TronSignTransactionRpcResponseData = Privy::Models::TronSignTransactionRpcResponseData

  TronTransactionCondition = Privy::Models::TronTransactionCondition

  TronTransactionConditionField = Privy::Models::TronTransactionConditionField
  ...
  WalletActionPayoutCreatedWebhookPayload = Privy::Models::WalletActionPayoutCreatedWebhookPayload

  WalletActionPayoutFailedWebhookPayload = Privy::Models::WalletActionPayoutFailedWebhookPayload

  WalletActionPayoutRejectedWebhookPayload = Privy::Models::WalletActionPayoutRejectedWebhookPayload

  WalletActionPayoutSucceededWebhookPayload = Privy::Models::WalletActionPayoutSucceededWebhookPayload
  ...
  WalletAutomationAttachmentListResponse = Privy::Models::WalletAutomationAttachmentListResponse
  ...
  WalletRecoverySetupMethod = Privy::Models::WalletRecoverySetupMethod
  ...
  XrplSignTransactionRpcInputParams = Privy::Models::XrplSignTransactionRpcInputParams

  XrplSignTransactionRpcResponse = Privy::Models::XrplSignTransactionRpcResponse

  XrplSignTransactionRpcResponseData = Privy::Models::XrplSignTransactionRpcResponseData
