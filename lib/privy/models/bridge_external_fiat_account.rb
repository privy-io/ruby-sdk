...
module Privy
  module Models
    class BridgeExternalFiatAccount < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::BridgeExternalFiatAccount::Provider]
      required :provider, enum: -> { Privy::BridgeExternalFiatAccount::Provider }
      ...
      #
      #   @param provider [Symbol, Privy::Models::BridgeExternalFiatAccount::Provider] Discriminator: the external fiat account is orchestrated via Bridge.
      #
      ...
      # Discriminator: the external fiat account is orchestrated via Bridge.
      #
      # @see Privy::Models::BridgeExternalFiatAccount#provider
      module Provider
