...
module Privy
  module Models
    class CreateExternalFiatAccountRequestBody < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::CreateExternalFiatAccountRequestBody::Provider]
      required :provider, enum: -> { Privy::CreateExternalFiatAccountRequestBody::Provider }
      ...
      # Discriminator: the external fiat account is orchestrated via Bridge.
      #
      # @see Privy::Models::CreateExternalFiatAccountRequestBody#provider
      module Provider
