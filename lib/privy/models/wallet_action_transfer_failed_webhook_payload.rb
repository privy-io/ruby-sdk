...
module Privy
  module Models
    class WalletActionTransferFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      # @!method initialize(action_type:, created_at:, destination_address:, failed_at:, failure_reason:, source_chain:, status:, steps:, type:, wallet_action_id:, wallet_id:, reference_id: nil, source_amount: nil, source_asset: nil, source_asset_address: nil, source_asset_decimals: nil)
