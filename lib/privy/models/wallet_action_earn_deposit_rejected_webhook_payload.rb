...
module Privy
  module Models
    class WalletActionEarnDepositRejectedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnDepositRejectedWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionEarnDepositRejectedWebhookPayload::Status }
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnDepositRejectedWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionEarnDepositRejectedWebhookPayload::Type }
      ...
      # @!method initialize(action_type:, asset_address:, caip2:, created_at:, failure_reason:, raw_amount:, rejected_at:, status:, steps:, type:, vault_address:, vault_id:, wallet_action_id:, wallet_id:, amount: nil, asset: nil, decimals: nil, reference_id: nil)
      ...
      #
      #   @param type [Symbol, Privy::Models::WalletActionEarnDepositRejectedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionEarnDepositRejectedWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionEarnDepositRejectedWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        WALLET_ACTION_EARN_DEPOSIT_REJECTED = :"wallet_action.earn_deposit.rejected"
