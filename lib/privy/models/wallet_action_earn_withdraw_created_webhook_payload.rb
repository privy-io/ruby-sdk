...
module Privy
  module Models
    class WalletActionEarnWithdrawCreatedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnWithdrawCreatedWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionEarnWithdrawCreatedWebhookPayload::Status }

      # @!attribute type
      #   The type of webhook event.
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnWithdrawCreatedWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionEarnWithdrawCreatedWebhookPayload::Type }
      ...
      #
      #   @param status [Symbol, Privy::Models::WalletActionEarnWithdrawCreatedWebhookPayload::Status] The status of the wallet action.
      #
      #   @param type [Symbol, Privy::Models::WalletActionEarnWithdrawCreatedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionEarnWithdrawCreatedWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionEarnWithdrawCreatedWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        WALLET_ACTION_EARN_WITHDRAW_CREATED = :"wallet_action.earn_withdraw.created"
