...
module Privy
  module Models
    ...
    module WebhookPayload
      ...
      variant -> { Privy::UserDeletedWebhookPayload }
      ...
      variant -> { Privy::WalletArchivedWebhookPayload }

      # Payload for the wallet.restored webhook event.
      variant -> { Privy::WalletRestoredWebhookPayload }
