...
module Privy
  module Models
    class WalletActionSwapFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      # @!method initialize(action_type:, caip2:, created_at:, failed_at:, failure_reason:, input_amount:, input_token:, output_token:, status:, steps:, type:, wallet_action_id:, wallet_id:, reference_id: nil)
