...
module Privy
  module Models
    class WalletActionEarnDepositCreatedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnDepositCreatedWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionEarnDepositCreatedWebhookPayload::Status }

      # @!attribute type
      #   The type of webhook event.
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnDepositCreatedWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionEarnDepositCreatedWebhookPayload::Type }
      ...
      # @!method initialize(action_type:, asset_address:, caip2:, created_at:, raw_amount:, status:, type:, vault_address:, vault_id:, wallet_action_id:, wallet_id:, amount: nil, asset: nil, decimals: nil, reference_id: nil)
      #   Some parameter documentations has been truncated, see
      #   {Privy::Models::WalletActionEarnDepositCreatedWebhookPayload} for more details.
      #
      ...
      #
      #   @param status [Symbol, Privy::Models::WalletActionEarnDepositCreatedWebhookPayload::Status] The status of the wallet action.
      #
      #   @param type [Symbol, Privy::Models::WalletActionEarnDepositCreatedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionEarnDepositCreatedWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionEarnDepositCreatedWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        WALLET_ACTION_EARN_DEPOSIT_CREATED = :"wallet_action.earn_deposit.created"
