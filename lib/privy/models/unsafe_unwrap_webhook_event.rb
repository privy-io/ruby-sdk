...
module Privy
  module Models
    ...
    module UnsafeUnwrapWebhookEvent
      ...
      variant :"organization.kyb.updated", -> { Privy::OrganizationKYBUpdatedWebhookEvent }
      ...
      variant :"usage.gas_sponsorship.recorded", -> { Privy::UsageGasSponsorshipRecordedWebhookPayload }

      # Payload for the usage.swap_provider_fee.recorded webhook event (swap provider fee on a cross-chain transfer or swap).
      variant :"usage.swap_provider_fee.recorded", -> { Privy::UsageSwapProviderFeeRecordedWebhookPayload }
      ...
      variant :"user.deleted", -> { Privy::UserDeletedWebhookPayload }

      variant :"user.kyc.updated", -> { Privy::UserKYCUpdatedWebhookEvent }
      ...
      variant :"wallet.deposit_account.deposit_completed",
              -> { Privy::WalletDepositAccountDepositCompletedWebhookEvent }

      variant :"wallet.deposit_account.deposit_failed",
              -> { Privy::WalletDepositAccountDepositFailedWebhookEvent }

      variant :"wallet.deposit_account.deposit_started",
      ...
      variant :"wallet.restored", -> { Privy::WalletRestoredWebhookPayload }
      ...
      variant :"wallet_action.earn_fee_collect.rejected",
      ...
      variant :"wallet_action.earn_fee_collect.succeeded",
      ...
      variant :"wallet_action.payout.created", -> { Privy::WalletActionPayoutCreatedWebhookPayload }

      # Payload for the wallet_action.payout.failed webhook event.
      variant :"wallet_action.payout.failed", -> { Privy::WalletActionPayoutFailedWebhookPayload }

      # Payload for the wallet_action.payout.rejected webhook event.
      variant :"wallet_action.payout.rejected", -> { Privy::WalletActionPayoutRejectedWebhookPayload }

      # Payload for the wallet_action.payout.succeeded webhook event.
      variant :"wallet_action.payout.succeeded", -> { Privy::WalletActionPayoutSucceededWebhookPayload }
      ...
      variant :"wallet_automation.submitted", -> { Privy::WalletAutomationSubmittedWebhookPayload }
