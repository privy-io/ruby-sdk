...
module Privy
  module Models
    class EarnDepositActionResponse < Privy::Internal::Type::BaseModel
      ...
      # @!attribute type
      #
      #   @return [Symbol, Privy::Models::EarnDepositActionResponse::Type]
      ...
      #   {Privy::Models::EarnDepositActionResponse} for more details.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::EarnDepositActionResponse::Type]
      #
      ...
      # @see Privy::Models::EarnDepositActionResponse#type
      module Type
