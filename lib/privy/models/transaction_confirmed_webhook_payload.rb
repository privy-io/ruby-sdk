...
module Privy
  module Models
    class TransactionConfirmedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::TransactionConfirmedWebhookPayload::Type]
      required :type, enum: -> { Privy::TransactionConfirmedWebhookPayload::Type }
      ...
      #   {Privy::Models::TransactionConfirmedWebhookPayload} for more details.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::TransactionConfirmedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::TransactionConfirmedWebhookPayload#type
      module Type
