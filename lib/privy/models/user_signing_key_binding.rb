...
module Privy
  module Models
    class UserSigningKeyBinding < Privy::Internal::Type::BaseModel
      ...
      # @!attribute type
      #
      #   @return [Symbol, Privy::Models::UserSigningKeyBinding::Type]
      required :type, enum: -> { Privy::UserSigningKeyBinding::Type }

      # @!method initialize(intent_id:, type:)
      #   A binding that scopes a user signing key to a specific intent.
      #
      #   @param intent_id [String]
      #   @param type [Symbol, Privy::Models::UserSigningKeyBinding::Type]

      # @see Privy::Models::UserSigningKeyBinding#type
      module Type
