  ...
  module Models
    module Wallets
      class TransferActionResponse < Privy::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Privy::Models::Wallets::TransferActionResponse::Type]
        required :type, enum: -> { Privy::Wallets::TransferActionResponse::Type }
        ...
        #
        #   @param type [Symbol, Privy::Models::Wallets::TransferActionResponse::Type]
        #
