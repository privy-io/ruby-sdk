...
module Privy
  module Models
    module Wallets
      class TempoVaultDetails < Privy::Internal::Type::BaseModel
        # @!attribute id
        #   Vault identifier.
        #
        #   @return [String]
        ...
        # @!attribute provider
        #
        #   @return [Symbol, Privy::Models::Wallets::TempoVaultDetails::Provider]
        required :provider, enum: -> { Privy::Wallets::TempoVaultDetails::Provider }
        ...
        #   {Privy::Models::Wallets::TempoVaultDetails} for more details.
        #
        ...
        #
        #   @param provider [Symbol, Privy::Models::Wallets::TempoVaultDetails::Provider]
        #
        ...
        # @see Privy::Models::Wallets::TempoVaultDetails#provider
        module Provider
