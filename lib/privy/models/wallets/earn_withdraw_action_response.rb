  ...
  module Models
    module Wallets
      class EarnWithdrawActionResponse < Privy::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Privy::Models::Wallets::EarnWithdrawActionResponse::Type]
        required :type, enum: -> { Privy::Wallets::EarnWithdrawActionResponse::Type }
        ...
        #
        #   @param type [Symbol, Privy::Models::Wallets::EarnWithdrawActionResponse::Type]
        #
        ...
        # @see Privy::Models::Wallets::EarnWithdrawActionResponse#type
        module Type
