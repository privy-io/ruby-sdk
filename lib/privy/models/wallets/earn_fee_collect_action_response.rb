  ...
  module Models
    module Wallets
      class EarnFeeCollectActionResponse < Privy::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, asset_address:, caip2:, created_at:, raw_amount:, status:, type:, vault_address:, vault_id:, wallet_id:, amount: nil, asset: nil, decimals: nil, failure_reason: nil, reference_id: nil, steps: nil)
