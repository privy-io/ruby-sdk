  ...
  module Models
    module Wallets
      class EarnDepositActionResponse < Privy::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Privy::Models::Wallets::EarnDepositActionResponse::Type]
        ...
        #   {Privy::Models::Wallets::EarnDepositActionResponse} for more details.
        #
        ...
        #
        #   @param share_amount [String, nil] Vault shares received in base units. Populated after on-chain confirmation.
        #
        #   @param status [Symbol, Privy::Models::Wallets::WalletActionStatus] Status of a wallet action.
        #
        #   @param type [Symbol, Privy::Models::Wallets::EarnDepositActionResponse::Type]
        #
        ...
        # @see Privy::Models::Wallets::EarnDepositActionResponse#type
        module Type
