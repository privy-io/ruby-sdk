...
module Privy
  module Models
    class FarcasterConnectStatusCompletedResponse < Privy::Internal::Type::BaseModel
      ...
      # @!attribute state
      #
      #   @return [Symbol, Privy::Models::FarcasterConnectStatusCompletedResponse::State]
      required :state, enum: -> { Privy::FarcasterConnectStatusCompletedResponse::State }
      ...
      #   @param state [Symbol, Privy::Models::FarcasterConnectStatusCompletedResponse::State]
      #   @param username [String]

      # @see Privy::Models::FarcasterConnectStatusCompletedResponse#state
      module State
