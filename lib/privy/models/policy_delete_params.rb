...
module Privy
  module Models
    # @see Privy::Resources::Policies#delete
    class PolicyDeleteParams < Privy::Internal::Type::BaseModel
      ...
      # @!method initialize(policy_id:, privy_authorization_signature: nil, privy_request_expiry: nil, request_options: {})
