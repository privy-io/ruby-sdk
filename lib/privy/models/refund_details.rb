...
module Privy
  module Models
    class RefundDetails < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::RefundDetails::Provider]
      required :provider, enum: -> { Privy::RefundDetails::Provider }
      ...
      #
      #   @param provider [Symbol, Privy::Models::RefundDetails::Provider] The provider that handled the refund.
      #
      #   @param wallet_action_id [String] The Privy wallet action ID of the transfer that was refunded.

      # The provider that handled the refund.
      #
      # @see Privy::Models::RefundDetails#provider
      module Provider
