...
module Privy
  module Models
    class WalletActionEarnWithdrawFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionEarnWithdrawFailedWebhookPayload::Status }
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionEarnWithdrawFailedWebhookPayload::Type }
      ...
      #   {Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload} for more details.
      #
      ...
      #
      #   @param status [Symbol, Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload::Status] The status of the wallet action.
      #
      #   @param steps [Array<Privy::Models::Wallets::EvmTransactionWalletActionStep, Privy::Models::Wallets::EvmUserOperationWalletActionStep, Privy::Models::Wallets::SvmTransactionWalletActionStep, Privy::Models::Wallets::TvmTransactionWalletActionStep, Privy::Models::Wallets::ExternalTransactionWalletActionStep, Privy::Models::Wallets::CustodianTransactionWalletActionStep, Privy::Models::Wallets::TempoZoneSettlementWalletActionStep>] The steps of the wallet action. Completed steps will have transaction hashes; th
      #
      #   @param type [Symbol, Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionEarnWithdrawFailedWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        WALLET_ACTION_EARN_WITHDRAW_FAILED = :"wallet_action.earn_withdraw.failed"
