...
module Privy
  module Models
    class FiatDepositAccount < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::FiatDepositAccount::Provider]
      required :provider, enum: -> { Privy::FiatDepositAccount::Provider }
      ...
      #
      #   @param provider [Symbol, Privy::Models::FiatDepositAccount::Provider] Discriminator: the fiat deposit account is orchestrated via Bridge.
      #
      ...
      # Discriminator: the fiat deposit account is orchestrated via Bridge.
      #
      # @see Privy::Models::FiatDepositAccount#provider
      module Provider
