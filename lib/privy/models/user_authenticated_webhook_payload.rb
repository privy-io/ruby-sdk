...
module Privy
  module Models
    class UserAuthenticatedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::UserAuthenticatedWebhookPayload::Type]
      required :type, enum: -> { Privy::UserAuthenticatedWebhookPayload::Type }
      ...
      #
      #   @param type [Symbol, Privy::Models::UserAuthenticatedWebhookPayload::Type] The type of webhook event.
      #
      #   @param user [Privy::Models::User] A Privy user object.

      # The type of webhook event.
      #
      # @see Privy::Models::UserAuthenticatedWebhookPayload#type
      module Type
