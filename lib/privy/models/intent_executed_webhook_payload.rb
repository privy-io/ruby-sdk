...
module Privy
  module Models
    class IntentExecutedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::IntentExecutedWebhookPayload::Type]
      ...
      #
      #   @param action_result [Privy::Models::BaseActionResult] Result of the successful intent execution.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::IntentExecutedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::IntentExecutedWebhookPayload#type
      module Type
