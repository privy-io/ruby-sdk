...
module Privy
  module Models
    class WalletActionPayoutSucceededWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionPayoutSucceededWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionPayoutSucceededWebhookPayload::Status }
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionPayoutSucceededWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionPayoutSucceededWebhookPayload::Type }
      ...
      # @!method initialize(action_type:, completed_at:, created_at:, destination_currency:, destination_fiat_account_id:, destination_payment_rail:, environment:, provider:, source_amount:, source_asset:, source_chain:, status:, steps:, type:, wallet_action_id:, wallet_id:, reference_id: nil)
      ...
      #
      #   @param status [Symbol, Privy::Models::WalletActionPayoutSucceededWebhookPayload::Status] The status of the wallet action.
      #
      #   @param steps [Array<Privy::Models::Wallets::EvmTransactionWalletActionStep, Privy::Models::Wallets::EvmUserOperationWalletActionStep, Privy::Models::Wallets::SvmTransactionWalletActionStep, Privy::Models::Wallets::TvmTransactionWalletActionStep, Privy::Models::Wallets::ExternalTransactionWalletActionStep, Privy::Models::Wallets::CustodianTransactionWalletActionStep, Privy::Models::Wallets::TempoZoneSettlementWalletActionStep>] The steps of the wallet action, including transaction hashes.
      #
      #   @param type [Symbol, Privy::Models::WalletActionPayoutSucceededWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionPayoutSucceededWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionPayoutSucceededWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        WALLET_ACTION_PAYOUT_SUCCEEDED = :"wallet_action.payout.succeeded"
