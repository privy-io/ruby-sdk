...
module Privy
  module Models
    class NearRpcResponse < Privy::Internal::Type::BaseModel
      ...
      # @!attribute method_
      #
      #   @return [Symbol, Privy::Models::NearRpcResponse::Method]
      required :method_, enum: -> { Privy::NearRpcResponse::Method }, api_name: :method
      ...
      #
      #   @param method_ [Symbol, Privy::Models::NearRpcResponse::Method]

      # @see Privy::Models::NearRpcResponse#method_
      module Method
