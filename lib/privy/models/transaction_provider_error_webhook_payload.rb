...
module Privy
  module Models
    class TransactionProviderErrorWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::TransactionProviderErrorWebhookPayload::Type]
      ...
      #   {Privy::Models::TransactionProviderErrorWebhookPayload} for more details.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::TransactionProviderErrorWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::TransactionProviderErrorWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        TRANSACTION_PROVIDER_ERROR = :"transaction.provider_error"
