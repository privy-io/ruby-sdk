...
module Privy
  module Models
    class CreateFiatDepositAccountRequestBody < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::CreateFiatDepositAccountRequestBody::Provider]
      required :provider, enum: -> { Privy::CreateFiatDepositAccountRequestBody::Provider }
      ...
      # Discriminator: the fiat deposit account is orchestrated via Bridge.
      #
      # @see Privy::Models::CreateFiatDepositAccountRequestBody#provider
      module Provider
