...
module Privy
  module Models
    class WalletActionEarnFeeCollectFailedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionEarnFeeCollectFailedWebhookPayload::Status }
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionEarnFeeCollectFailedWebhookPayload::Type }
      ...
      #   {Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload} for more
      #   details.
      #
      ...
      #
      #   @param status [Symbol, Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload::Status] The status of the wallet action.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionEarnFeeCollectFailedWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum
