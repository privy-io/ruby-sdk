...
module Privy
  module Models
    class AutomationDepositTriggerConfig < Privy::Internal::Type::BaseModel
      ...
      # @!attribute type
      #
      #   @return [Symbol, Privy::Models::AutomationDepositTriggerConfig::Type]
      required :type, enum: -> { Privy::AutomationDepositTriggerConfig::Type }
      ...
      #
      #   @param type [Symbol, Privy::Models::AutomationDepositTriggerConfig::Type]

      # @see Privy::Models::AutomationDepositTriggerConfig#type
      module Type
