...
module Privy
  module Models
    class ListExternalFiatAccountsResponse < Privy::Internal::Type::BaseModel
      ...
      required :external_fiat_accounts, -> { Privy::Internal::Type::ArrayOf[Privy::ExternalFiatAccount] }
      ...
      #
      #   @param external_fiat_accounts [Array<Privy::Models::ExternalFiatAccount>]
