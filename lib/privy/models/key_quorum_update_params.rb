...
module Privy
  module Models
    # @see Privy::Resources::KeyQuorums#update
    class KeyQuorumUpdateParams < Privy::Models::KeyQuorumUpdateRequestBody
      ...
      # @!method initialize(key_quorum_id:, privy_authorization_signature: nil, privy_request_expiry: nil, request_options: {})
