...
module Privy
  module Models
    class WalletActionTransferCreatedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::WalletActionTransferCreatedWebhookPayload::Status]
      required :status, enum: -> { Privy::WalletActionTransferCreatedWebhookPayload::Status }

      # @!attribute type
      #   The type of webhook event.
      #
      #   @return [Symbol, Privy::Models::WalletActionTransferCreatedWebhookPayload::Type]
      required :type, enum: -> { Privy::WalletActionTransferCreatedWebhookPayload::Type }
      ...
      # @!method initialize(action_type:, created_at:, destination_address:, source_chain:, status:, type:, wallet_action_id:, wallet_id:, reference_id: nil, source_amount: nil, source_asset: nil, source_asset_address: nil, source_asset_decimals: nil)
      ...
      #
      #   @param type [Symbol, Privy::Models::WalletActionTransferCreatedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The status of the wallet action.
      #
      # @see Privy::Models::WalletActionTransferCreatedWebhookPayload#status
      module Status
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::WalletActionTransferCreatedWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        WALLET_ACTION_TRANSFER_CREATED = :"wallet_action.transfer.created"
