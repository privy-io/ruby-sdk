...
module Privy
  module Models
    class TransactionReplacedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::TransactionReplacedWebhookPayload::Type]
      required :type, enum: -> { Privy::TransactionReplacedWebhookPayload::Type }
      ...
      #   {Privy::Models::TransactionReplacedWebhookPayload} for more details.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::TransactionReplacedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::TransactionReplacedWebhookPayload#type
      module Type
