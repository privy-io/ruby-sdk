...
module Privy
  module Models
    class WalletActionPayoutCreatedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      # @!method initialize(action_type:, created_at:, destination_currency:, destination_fiat_account_id:, destination_payment_rail:, environment:, provider:, source_amount:, source_asset:, source_chain:, status:, type:, wallet_action_id:, wallet_id:)
