...
module Privy
  module Models
    class HDSubmitInput < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::HDSubmitInput::EntropyType]
      ...
      # @!method initialize(address:, chain_type:, ciphertext:, encapsulated_key:, encryption_type:, entropy_type:, index:, hpke_config: nil)
      #   Some parameter documentations has been truncated, see
      #   {Privy::Models::HDSubmitInput} for more details.
      #
      ...
      #
      #   @param entropy_type [Symbol, Privy::Models::HDSubmitInput::EntropyType] The entropy type of the wallet to import.
      #
      ...
      # The entropy type of the wallet to import.
      #
      # @see Privy::Models::HDSubmitInput#entropy_type
      module EntropyType
