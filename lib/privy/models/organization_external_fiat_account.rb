...
module Privy
  module Models
    class OrganizationExternalFiatAccount < Privy::Internal::Type::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      #
      #   @return [Symbol, Privy::Models::OrganizationExternalFiatAccount::Provider]
      required :provider, enum: -> { Privy::OrganizationExternalFiatAccount::Provider }
      ...
      #
      #   @param provider [Symbol, Privy::Models::OrganizationExternalFiatAccount::Provider] Discriminator: the external fiat account is orchestrated via Bridge.
      #
      ...
      # Discriminator: the external fiat account is orchestrated via Bridge.
      #
      # @see Privy::Models::OrganizationExternalFiatAccount#provider
      module Provider
