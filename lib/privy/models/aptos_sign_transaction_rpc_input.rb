...
module Privy
  module Models
    class AptosSignTransactionRpcInput < Privy::Internal::Type::BaseModel
      # @!attribute method_
      #
      #   @return [Symbol, Privy::Models::AptosSignTransactionRpcInput::Method]
      required :method_, enum: -> { Privy::AptosSignTransactionRpcInput::Method }, api_name: :method
      ...
      #
      #   @param method_ [Symbol, Privy::Models::AptosSignTransactionRpcInput::Method]
      #
      #   @param params [Privy::Models::AptosSignTransactionRpcInputParams] Parameters for the Aptos `aptos_signTransaction` RPC.

      # @see Privy::Models::AptosSignTransactionRpcInput#method_
      module Method
