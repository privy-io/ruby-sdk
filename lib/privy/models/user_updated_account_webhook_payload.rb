...
module Privy
  module Models
    class UserUpdatedAccountWebhookPayload < Privy::Internal::Type::BaseModel
      # @!attribute account
      ...
      #
      #   @return [Symbol, Privy::Models::UserUpdatedAccountWebhookPayload::Type]
      required :type, enum: -> { Privy::UserUpdatedAccountWebhookPayload::Type }
      ...
      #
      #   @param type [Symbol, Privy::Models::UserUpdatedAccountWebhookPayload::Type] The type of webhook event.
      #
      #   @param user [Privy::Models::User] A Privy user object.

      # The type of webhook event.
      #
      # @see Privy::Models::UserUpdatedAccountWebhookPayload#type
      module Type
        extend Privy::Internal::Type::Enum

        USER_UPDATED_ACCOUNT = :"user.updated_account"
