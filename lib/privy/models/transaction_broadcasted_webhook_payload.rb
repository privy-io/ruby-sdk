...
module Privy
  module Models
    class TransactionBroadcastedWebhookPayload < Privy::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Privy::Models::TransactionBroadcastedWebhookPayload::Type]
      required :type, enum: -> { Privy::TransactionBroadcastedWebhookPayload::Type }
      ...
      #   {Privy::Models::TransactionBroadcastedWebhookPayload} for more details.
      #
      ...
      #
      #   @param type [Symbol, Privy::Models::TransactionBroadcastedWebhookPayload::Type] The type of webhook event.
      #
      ...
      # The type of webhook event.
      #
      # @see Privy::Models::TransactionBroadcastedWebhookPayload#type
      module Type
