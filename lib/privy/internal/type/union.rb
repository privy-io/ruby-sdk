  ...
  module Internal
    module Type
      ...
      module Union
        ...
        include Privy::Internal::Util::SorbetRuntimeSupport
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, Privy::Internal::Type::Converter, Class]
        #
        # @param spec [Hash{Symbol=>Object}, Proc, Privy::Internal::Type::Converter, Class] .
        #
        ...
        private def variant(key, spec = nil)
          meta = Privy::Internal::Type::Converter.meta_info(nil, spec)
          variant_info =
            case key
            in Symbol
              [key, Privy::Internal::Type::Converter.type_info(spec), meta]
            in Proc | Privy::Internal::Type::Converter | Class | Hash
              [nil, Privy::Internal::Type::Converter.type_info(key), meta]
            end
        ...
        # @param value [Object]
        #
        # @return [Privy::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, Privy::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, Privy::Internal::OMIT)
            end

            return nil if key == Privy::Internal::OMIT
        ...
        # @return [Boolean]
        def ==(other)
          Privy::Internal::Type::Union === other && other.derefed_variants == derefed_variants
        end
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return Privy::Internal::Type::Converter.coerce(target, value, state: state)
          end
        ...
        def dump(value, state:)
          if (target = resolve_variant(value))
            return Privy::Internal::Type::Converter.dump(target, value, state: state)
          end

          known_variants.each do
            target = _2.call
            return Privy::Internal::Type::Converter.dump(target, value, state: state) if target === value
          end
        ...
        # @return [Object]
        def to_sorbet_type
          types = variants.map { Privy::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
        ...
        def inspect(depth: 0)
          ...
          members = variants.map { Privy::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
