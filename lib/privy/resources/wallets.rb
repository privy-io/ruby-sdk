...
module Privy
  module Resources
    class Wallets
      ...
      #
      # @overload _transfer(wallet_id, destination:, source:, amount_type: nil, slippage_bps: nil, privy_authorization_signature: nil, privy_idempotency_key: nil, privy_request_expiry: nil, request_options: {})
      #
      # @param wallet_id [String] Path param: ID of the wallet.
      #
