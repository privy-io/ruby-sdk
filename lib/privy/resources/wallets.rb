...
module Privy
  module Resources
    class Wallets
      ...
      #
      # @overload update(wallet_id, additional_signers: nil, display_name: nil, external_id: nil, owner: nil, owner_id: nil, policy_ids: nil, privy_authorization_signature: nil, privy_request_expiry: nil, request_options: {})
      #
